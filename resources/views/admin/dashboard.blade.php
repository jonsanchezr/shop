		...
		<div class="row">
			...
			<div class="col-12 col-lg-4 d-flex">
				<div class="card flex-fill w-100">
					...
					<div class="card-body">
						<div class="media">
							<img src="{{asset('assets-admin/img/avatars/avatar-5.jpg')}}" width="36" height="36" class="rounded-circle mr-2" alt="Ashley Briggs">
							<div class="media-body">
						...
						<hr>
						<div class="media">
							<img src="{{asset('assets-admin/img/avatars/avatar.jpg')}}" width="36" height="36" class="rounded-circle mr-2" alt="Chris Wood">
							<div class="media-body">
						...
						<hr>
						<div class="media">
							<img src="{{asset('assets-admin/img/avatars/avatar-4.jpg')}}" width="36" height="36" class="rounded-circle mr-2" alt="Stacie Hall">
							<div class="media-body">
