...
<div class="container pb-5 mb-3">
  ...
  <div class="d-md-table w-100 p-4 p-lg-5 mb-30 box-shadow">
    <div class="d-md-table-cell align-middle mx-auto mb-4 mb-md-0" style="width: 150px;"><img class="d-block w-100" src="{{ asset('assets/img/pages/about-icons/01.png')}}" alt="Buy Online"></div>
  ...
  <!-- Delivery Worldwide-->
  <div class="d-md-table w-100 p-4 p-lg-5 mb-30 box-shadow">
    <div class="d-md-table-cell align-middle mx-auto mb-4 mb-md-0" style="width: 150px;"><img class="d-block w-100" src="{{ asset('assets/img/pages/about-icons/02.png')}}" alt="Delivery Worldwide"></div>
    <div class="d-md-table-cell align-middle pl-md-4 pl-lg-5 text-center text-md-left">
  ...
  <!-- Mobile App-->
  <div class="d-md-table w-100 p-4 p-lg-5 mb-30 box-shadow">
    <div class="d-md-table-cell align-middle mx-auto mb-4 mb-md-0" style="width: 150px;"><img class="d-block w-100" src="{{ asset('assets/img/pages/about-icons/03.png')}}" alt="Mobile App"></div>
    <div class="d-md-table-cell align-middle pl-md-4 pl-lg-5 text-center text-md-left">
  ...
  <div class="d-md-table w-100 p-4 p-lg-5 box-shadow">
    <div class="d-md-table-cell align-middle mx-auto mb-4 mb-md-0" style="width: 150px;"><img class="d-block w-100" src="{{ asset('assets/img/pages/about-icons/04.png')}}" alt="Outlet Stores"></div>
    <div class="d-md-table-cell align-middle pl-md-4 pl-lg-5 text-center text-md-left">
