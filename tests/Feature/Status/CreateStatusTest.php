...
class CreateStatusTest extends TestCase
{
   ...
   /** @test */
    public function admin_user_can_create_status()
    {
      $this->signIn('admin');
    ...
    /** @test */
    public function public_user_cant_create_status()
    {
        $this->signIn('user');
        $response = $this->makeRequest();
    ...
    private function makeRequest($attributes = []): TestResponse
    {
      ...
      return $this->post(route('status.store'), array_merge($nowData, $attributes));
    }
